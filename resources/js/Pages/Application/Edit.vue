<template>
    <app-layout title="Edit Application">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="hidden sm:block">
                    <nav class="relative z-0 rounded-lg shadow flex divide-x divide-gray-200" aria-label="Tabs">
                        <button @click="changeTab('applicant')" :class="[currentTab == 'applicant' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700', 'rounded-l-lg', 'group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-sm font-medium text-center hover:bg-gray-50 focus:z-10',applicantHasError()]" :aria-current="currentTab == 'applicant' ? 'page' : undefined">
                        ...
                        <button @click="changeTab('arrested_person')" :class="[currentTab == 'arrested_person' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700', 'group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-sm font-medium text-center hover:bg-gray-50 focus:z-10',arrestedPersonHasError()]" :aria-current="currentTab == 'arrested_person' ? 'page' : undefined">
                        ...
                        <button @click="changeTab('details_arrest')" :class="[currentTab == 'details_arrest' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700', 'group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-sm font-medium text-center hover:bg-gray-50 focus:z-10',detailsArrestHasError()]" :aria-current="currentTab == 'details_arrest' ? 'page' : undefined">
                        ...
                        <button @click="changeTab('warrantless_arrest')" :class="[currentTab == 'warrantless_arrest' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700', 'group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-sm font-medium text-center hover:bg-gray-50 focus:z-10']" :aria-current="currentTab == 'warrantless_arrest' ? 'page' : undefined">
                        ...
                        <button @click="changeTab('request_details')" :class="[currentTab == 'request_details' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700','rounded-r-lg', 'group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-sm font-medium text-center hover:bg-gray-50 focus:z-10', requestDetailsHasError()]" :aria-current="currentTab == 'request_details' ? 'page' : undefined">
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                        ...
                        <div class="grid grid-cols-9 gap-6">
                            <div class="col-span-9 sm:col-span-9 lg:col-span-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" id="date" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10  border-gray-300 rounded-md bg-gray-300" disabled="disabled" :value="currentDate" />
                                </div>
                            </div>
                    ...
                    <div v-show="currentTab == 'arrested_person'" class="bg-white py-6 px-4 space-y-6 sm:p-6">
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-12">
                                ...
                                <input v-if="form.arrested_picture_path == null" type="file" id="arrested_picture" @input="form.arrested_picture = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 px-3 py-1.5" accept="image/*" />
                                <div v-if="form.arrested_picture_path != null" class="inline-flex justify-center items-center gap-4 mt-3">
                                    <button type="button" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" @click="form.arrested_picture_path = null">
                                        <XIcon class="h-4 w-4" aria-hidden="true" />
                                    </button>
                                    <label class="block text-sm font-medium text-gray-700 ">{{form.arrested_picture_path.file_name}}</label>
                                </div>
                                ...
                                <fieldset class="mt-4">
                                    <div class="space-y-4">
                                        <div class="flex items-center">
                                            ...
                                            <label for="single" class="ml-3 block text-sm font-medium text-gray-700">
                                                Single
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="married" class="ml-3 block text-sm font-medium text-gray-700">
                                                Married
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="widowed" class="ml-3 block text-sm font-medium text-gray-700">
                                                Widowed
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="separated" class="ml-3 block text-sm font-medium text-gray-700">
                                                Separated
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-span-12">
                                <label class="block text-sm font-extrabold text-2xl text-gray-700">Physical Depiction</label>
                            </div>
                                ...
                                <fieldset class="mt-4">
                                    <div class="flex space-x-4">
                                        <div class="flex items-center">
                                            ...
                                            <label for="mole" class="ml-2 block text-sm font-medium text-gray-700">
                                                Mole
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="tattoo" class="ml-2 block text-sm font-medium text-gray-700">
                                                Tattoo
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="birthmark" class="ml-2 block text-sm font-medium text-gray-700">
                                                Birthmark
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="scar" class="ml-2 block text-sm font-medium text-gray-700">
                                                Scar
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <textarea id="arrested_location_marks" class="block w-full pr-10 focus:outline-none  rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300" v-model="form.arrested_location_marks" placeholder="Enter location of identifying marks..."></textarea>
                            </div>

                            <div class="col-span-12">
                                <label for="arrested_defect" class="form-label"> Physical Deformity</label>
                                <textarea id="arrested_defect" class="block w-full pr-10 focus:outline-none  rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300" v-model="form.arrested_defect" placeholder="Enter physical deformity..."></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-show="currentTab == 'details_arrest'" class="bg-white py-6 px-4 space-y-6 sm:p-6">
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-12 md:col-span-6">
                                ...
                                <input type="text" id="who" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full  border-gray-300 rounded-md bg-gray-300" disabled="disabled" :value="fullName" />
                            </div>
                            <div class="col-span-12 md:col-span-6">
                            ...
                            <fieldset class="mt-4">
                                <div class="flex space-x-4">
                                    <div class="flex items-center">
                                        ...
                                        <label for="elderly" class="ml-2 block text-sm font-medium text-gray-700">
                                            Elderly
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="pwd" class="ml-2 block text-sm font-medium text-gray-700">
                                            PWD
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="pregnant_woman" class="ml-2 block text-sm font-medium text-gray-700">
                                            Pregnant Woman
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="woman" class="ml-2 block text-sm font-medium text-gray-700">
                                            Woman
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="children" class="ml-2 block text-sm font-medium text-gray-700">
                                            Children
                                        </label>
                                    </div>
                                </div>
                            ...
                            <fieldset class="mt-4">
                                <div class="flex space-x-4">
                                    <div class="flex items-center">
                                        ...
                                        <label for="is_informed_of_right-yes" class="ml-2 block text-sm font-medium text-gray-700">
                                            YES
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="is_informed_of_right-no" class="ml-2 block text-sm font-medium text-gray-700">
                                            NO
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div v-show="currentTab == 'request_details'" class="bg-white py-6 px-4 space-y-6 sm:p-6">
                        <div class="overflow-x-auto overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                            <table class="w-full divide-y divide-gray-300">
                                <thead class="bg-green-600">
                                    <tr>
                                        <th scope="col" class="py-3.5 w-full pl-4 pr-3 text-left  font-semibold text-white sm:pl-6">Reason for Application For Extension<span v-if="application.is_extension" style="color: red">*</span></th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr>
                        ...
                        <div class="mt-6 overflow-x-auto overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                            <table class="w-full divide-y divide-gray-300">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3  font-medium text-gray-900 sm:pl-6">
                                            <textarea id="reason_narration" class="block w-full pr-10 focus:outline-none  rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300" v-model="form.reason_narration" placeholder="Enter narration of reason for extension..."></textarea>
                                ...
                                <tbody class="bg-white">
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3  font-medium text-gray-900 sm:pl-6">
                                            ...
                                            <input v-if="form.sworn_affidavit_path == null" type="file" id="sworn_affidavit" @input="form.sworn_affidavit = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 px-3 py-1.5" />
                                            <div v-if="form.sworn_affidavit_path != null" class="inline-flex justify-center items-center gap-4 mt-3">
                                                <button type="button" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" @click="form.sworn_affidavit_path = null">
                                                    <XIcon class="h-4 w-4" aria-hidden="true" />
                                                </button>
                                                <label class="block text-sm font-medium text-gray-700 ">{{form.sworn_affidavit_path.file_name}}</label>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3  font-medium text-gray-900 sm:pl-6">
                                            ...
                                            <input v-if="form.sworn_affidavit_witness_path == null" type="file" id="sworn_affidavit_witness" @input="form.sworn_affidavit_witness = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 px-3 py-1.5" />
                                            <div v-if="form.sworn_affidavit_witness_path != null" class="inline-flex justify-center items-center gap-4 mt-3">
                                                <button type="button" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" @click="form.sworn_affidavit_witness_path = null">
                                                    <XIcon class="h-4 w-4" aria-hidden="true" />
                                                </button>
                                                <label class="block text-sm font-medium text-gray-700 ">{{form.sworn_affidavit_witness_path.file_name}}</label>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3  font-medium text-gray-900 sm:pl-6">
                                            ...
                                            <input v-if="form.warrantless_arrest_path == null" type="file" id="warrantless_arrest" @input="form.warrantless_arrest = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 px-3 py-1.5" />
                                            <div v-if="form.warrantless_arrest_path != null" class="inline-flex justify-center items-center gap-4 mt-3">
                                                <button type="button" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" @click="form.warrantless_arrest_path = null">
                                                    <XIcon class="h-4 w-4" aria-hidden="true" />
                                                </button>
                                                <label class="block text-sm font-medium text-gray-700 ">{{form.warrantless_arrest_path.file_name}}</label>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3  font-medium text-gray-900 sm:pl-6">
                                            ...
                                            <input v-if="form.book_sheet_path == null" type="file" id="book_sheet" @input="form.book_sheet = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 px-3 py-1.5" />
                                            <div v-if="form.book_sheet_path != null" class="inline-flex justify-center items-center gap-4 mt-3">
                                                <button type="button" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" @click="form.book_sheet_path = null">
                                                    <XIcon class="h-4 w-4" aria-hidden="true" />
                                                </button>
                                                <label class="block text-sm font-medium text-gray-700 ">{{form.book_sheet_path.file_name}}</label>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3  font-medium text-gray-900 sm:pl-6">
                                            ...
                                            <input v-if="form.spot_report_path == null" type="file" id="spot_report" @input="form.spot_report = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 px-3 py-1.5" />
                                            <div v-if="form.spot_report_path != null" class="inline-flex justify-center items-center gap-4 mt-3">
                                                <button type="button" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" @click="form.spot_report_path = null">
                                                    <XIcon class="h-4 w-4" aria-hidden="true" />
                                                </button>
                                                <label class="block text-sm font-medium text-gray-700 ">{{form.spot_report_path.file_name}}</label>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3  font-medium text-gray-900 sm:pl-6">
                                            ...
                                            <input v-if="form.logbook_path == null" type="file" id="logbook" @input="form.logbook = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100 px-3 py-1.5" />
                                            <div v-if="form.logbook_path != null" class="inline-flex justify-center items-center gap-4 mt-3">
                                                <button type="button" class="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" @click="form.logbook_path = null">
                                                    <XIcon class="h-4 w-4" aria-hidden="true" />
                                                </button>
                                                <label class="block text-sm font-medium text-gray-700 ">{{form.logbook_path.file_name}}</label>
                                            </div>
                                            ...
                                            <div class="rounded-md bg-blue-50 p-4 mb-6">
                                                <div class="flex">
                                                    ...
                                                    <div class="ml-3 flex-1 md:flex md:justify-between">
                                                        <p class="text-sm text-blue-700">Upload only 1GB per file.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <file-pond
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                        <button v-if="application.can_update" type="submit" class="btn btn-primary" @click="updateApplication">
                            Update
                        </button>
                        <button v-if="application.can_update_draft" type="button" class="btn btn-danger" @click="deleteDraft" :class="{ 'opacity-25': form.processing || uploadProgress }" :disabled="form.processing || uploadProgress">
                            Delete Draft
                        </button>
                        <button v-if="application.status === 'draft' && application.can_update_draft" type="submit" class="btn btn-primary ml-4" :class="{ 'opacity-25': form.processing || uploadProgress }" :disabled="form.processing || uploadProgress" @click="submitDraft">
                            Submit Draft
                        </button>
                        <button v-if="application.can_update_draft" type="submit" class="btn btn-success ml-4" @click="updateDraft" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                            Update Draft
                        </button>
                    </div>
                </div>
...
<script>
    ...
    import { CalendarIcon, InformationCircleIcon, XIcon } from '@heroicons/vue/solid'
    ...
    export default defineComponent({
        ...
        props: [
            'application',
            'arrested_picture_path',
            'sworn_affidavit_path',
            'logbook_path',
            'book_sheet_path',
            'spot_report_path',
            'sworn_affidavit_witness_path',
            'warrantless_arrest_path',
            'supporting_documents',
            'errors'
        ],
        mounted() {
            this.supporting_documents.forEach((media,index) => {
                this.documents.push({
                    source: media.uuid,
                    options: {
                        type: 'local',
                ...
                this.form.temporary_documents.push(media.uuid)
            })
        },
        data() {
            return {
                ...
                form: this.$inertia.form({
                    ...
                    rank: this.application.rank,
                    badge_number: this.application.badge_number,
                    unit: this.application.unit,
                    office_address: this.application.office_address,
                    tel: this.application.tel,
                    arrested_picture: null,
                    arrested_picture_path: this.arrested_picture_path,
                    arrested_firstname: this.application.arrested_firstname,
                    arrested_middlename: this.application.arrested_middlename,
                    arrested_lastname: this.application.arrested_lastname,
                    arrested_suffix: this.application.arrested_suffix,
                    arrested_address: this.application.arrested_address,
                    arrested_tel: this.application.arrested_tel,
                    arrested_pob: this.application.arrested_pob,
                    arrested_dob: this.application.arrested_dob,
                    arrested_sex: this.application.arrested_sex,
                    arrested_status: this.application.arrested_status,
                    arrested_spouse_name: this.application.arrested_spouse_name,
                    arrested_spouse_address: this.application.arrested_spouse_address,
                    arrested_age: this.application.arrested_age,
                    arrested_weight: this.application.arrested_weight,
                    arrested_height: this.getHeight(this.application.arrested_height),
                    arrested_eyes: this.application.arrested_eyes,
                    arrested_hair: this.application.arrested_hair,
                    arrested_complexion: this.application.arrested_complexion,
                    arrested_occupation: this.application.arrested_occupation,
                    arrested_nationality: this.application.arrested_nationality,
                    arrested_tribe: this.application.arrested_tribe,
                    arrested_language: this.application.arrested_language,
                    arrested_educ_attainment: this.application.arrested_educ_attainment,
                    arrested_school_name: this.application.arrested_school_name,
                    arrested_school_address: this.application.arrested_school_address,
                    arrested_marks: this.application.arrested_marks,
                    arrested_location_marks: this.application.arrested_location_marks,
                    arrested_defect: this.application.arrested_defect,
                    who: this.application.who,
                    when: this.application.when,
                    where: this.application.where,
                    what: this.application.what,
                    why: this.application.why,
                    how: this.application.how,
                    other_details: this.application.other_details,
                    physical_condition: this.application.physical_condition,
                    mental_condition: this.application.mental_condition,
                    arrested_category: this.application.arrested_category,
                    is_informed_of_right: this.application.is_informed_of_right,
                    extension_reason: this.application.extension_reason ?? [],
                    reason_narration: this.application.reason_narration,
                    sworn_affidavit: null,
                    sworn_affidavit_path: this.sworn_affidavit_path,
                    spot_report: null,
                    spot_report_path: this.spot_report_path,
                    logbook: null,
                    logbook_path: this.logbook_path,
                    sworn_affidavit_witness: null,
                    sworn_affidavit_witness_path: this.sworn_affidavit_witness_path,
                    warrantless_arrest: null,
                    warrantless_arrest_path: this.warrantless_arrest_path,
                    book_sheet: null,
                    book_sheet_path: this.book_sheet_path,
                    temporary_documents: [],
                    height_unit: this.getHeightUnit(this.application.arrested_height)
                }),
                document_error: '',
        ...
        methods: {
            ...
            clearChoices() {
                ...
                this.form.arrested_category = ''
                this.form.is_informed_of_right = ''
            },
            updateApplication() {
                ...
                })).post(route('applications.update',{
                    _method: 'put',
                    application: this.application.id,
                }))
            },
            deleteDraft() {
                this.form.delete(route('applications.delete.draft',{
                    application: this.application.id,
                }))
            },
            updateDraft() {
                ...
                this.form.transform((data) => ({
                    ...
                    when: moment(data.when).format('YYYY-MM-DD HH:mm'),
                    arrested_height: data.arrested_height == '' ? '' : data.arrested_height + ' ' + data.height_unit
                })).post(route('applications.update.draft',{
                    _method: 'put',
                    application: this.application.id,
                }))
            },
            submitDraft() {
                ...
                this.form.transform((data) => ({
                    ...
                    when: moment(data.when).format('YYYY-MM-DD HH:mm'),
                    arrested_height: data.arrested_height == '' ? '' : data.arrested_height + ' ' + data.height_unit
                })).post(route('applications.draft.submit',{
                    _method: 'put',
                    application: this.application.id,
                }))
            },
            onRemoveFile(error, file) {
                ...
                let index = this.documents.map(object => object.source).indexOf(file.serverId)
                this.documents.splice(index,1)

                index = this.form.temporary_documents.indexOf(file.serverId)
            ...
            getHeight(height) {
                ...
                arrayHeight.splice(arrayHeight.length - 1,1)
                return arrayHeight.join(' ')
            },
            getHeightUnit(height) {
                if (height == null)
                    return 'feet/meters'

                let arrayHeight = height.split(' ')
                return arrayHeight[arrayHeight.length - 1]
            },
        },
        computed: {
            currentDate() {
