<template>
    <Modal :show="show" @close="close">
        ...
        <template #footer>
            ...
            <button class="ml-4 btn btn-success" @click="submit" :class="{ 'opacity-25': form.processing || uploadProgress }" :disabled="form.processing || uploadProgress">Endorse</button>
        </template>
    </Modal>
</template>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            submit() {
                this.form.post(route('applications.endorse',{application:this.id}),{
