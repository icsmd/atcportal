<template>
    <Modal :show="show" @close="close">
        ...
        <template #footer>
            ...
            <button class="ml-4 btn btn-danger" @click="submit" :class="{ 'opacity-25': form.processing || uploadProgress }" :disabled="form.processing || uploadProgress">Disapprove</button>
        </template>
    </Modal>
</template>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            submit() {
                this.form.post(route('applications.disapprove',{application:this.id}),{
