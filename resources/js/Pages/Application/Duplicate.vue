            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                        ...
                        <button type="submit" class="btn btn-primary" @click="sendApplication" :class="{ 'opacity-25': form.processing || uploadProgress }" :disabled="form.processing || uploadProgress">Submit</button>
                        <button type="submit" class="btn btn-success ml-4" @click="saveDrafts" :class="{ 'opacity-25': form.processing || uploadProgress }" :disabled="form.processing || uploadProgress">Save as Draft</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        data() {
            return {
                ...
                form: this.$inertia.form({
                    ...
                    arrested_picture_path: null,
                    arrested_firstname: null,
                    arrested_middlename: null,
                    arrested_lastname: null,
                    arrested_suffix: null,
                    arrested_address: null,
                    arrested_tel: null,
                    arrested_pob: null,
                    arrested_dob: null,
                    arrested_sex: null,
                    arrested_status: null,
                    arrested_spouse_name: [''],
                    arrested_spouse_address: [''],
                    arrested_age: null,
                    arrested_weight: null,
                    arrested_height: null,
                    arrested_eyes: 'brown',
                    arrested_hair: 'brown',
                    arrested_complexion: 'fair',
                    arrested_occupation: null,
                    arrested_nationality: null,
                    arrested_tribe: null,
                    arrested_language: null,
                    arrested_educ_attainment: null,
                    arrested_school_name: null,
                    arrested_school_address: null,
                    arrested_marks: [],
                    arrested_location_marks: null,
                    arrested_defect: null,
