...
class ApplicationExtensionRequest extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('This application wants to extend its application.')
    ...
    public function toSms($notifiable)
    {
        return (new PinpointSmsMessage())
            ->create('Application '.$this->application->control_number.' wants to extend its application.');
    }
}
