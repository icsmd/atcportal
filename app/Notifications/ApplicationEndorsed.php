...
class ApplicationEndorsed extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('This application has been endorsed!')
    ...
    public function toSms($notifiable)
    {
        return (new PinpointSmsMessage())
            ->create('Application '.$this->application->control_number.' has been endorsed!');
    }
}
