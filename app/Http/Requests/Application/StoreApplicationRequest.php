...
class StoreApplicationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'tel' => ['required'],
            'arrested_picture' => ['required', 'file', 'image', 'max:5000'],
            ...
            'when' => ['required', 'date', 'before:now', 'after:'.now()->subDays(config('atc.access.days_of_detention'))->format('m/d/Y')],
            'where' => ['required'],
            'what' => ['required'],
            'how' => ['required'],
            'other_details' => ['required'],
            'extension_reason' => ['nullable', 'array'],
            'reason_narration' => ['required'],
            'sworn_affidavit' => ['required', 'file', 'max:5000'],
            'logbook' => ['required', 'file', 'max:5000'],
            'book_sheet' => ['required', 'file', 'max:5000'],
            'spot_report' => ['required', 'file', 'max:5000'],
    ...
    public function messages()
    {
        return [
            ...
            'arrested_picture.required' => 'The mugshot field is required.',
            ...
            'sworn_affidavit.required' => 'The sworn affidavit of arresting officer field is required.',
            ...
            'spot_report.required' => 'The spot report field is required.',
